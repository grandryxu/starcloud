...
namespace XMX.WMS.Roles
{
    ...
    public class RoleAppService : AsyncCrudAppService<Role, RoleDto, int, PagedRoleResultRequestDto, CreateRoleDto, RoleDto>, IRoleAppService
    {
        ...
        public RoleAppService(IRepository<Role> repository, RoleManager roleManager, UserManager userManager, IPermissionManager permissionManager)
            : base(repository)
        {
        ...
        public async Task UpdateRolePermissions(UpdateRolePermissionsInput input)
        {
            ...
            .Where(p => input.GrantedPermissionNames.Contains(p.Name)).ToList();
        ...
        {
            return _permissionManager.GetAllPermissions().ToList();
        }
    }
}
