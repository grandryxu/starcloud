...
{
    public class PalletizingInfoPagedRequest : PagedResultRequestDto
    {
        /// <summary>
        /// 编码
        /// </summary>
    ...
    #region 创建CreateDto
    [AutoMapTo(typeof(PalletizingInfo))]
    public class PalletizingInfoCreatedDto : BaseCreateDto
    {
        #region 属性
        /// <summary>
        /// 编码
    ...
    #region 修改UpdateDto
    [AutoMapTo(typeof(PalletizingInfo))]
    public class PalletizingInfoUpdatedDto : BaseUpdateDto
    {
        #region 属性
        /// <summary>
        /// 编码
    ...
    #region 查询输出dto
    [AutoMapFrom(typeof(PalletizingInfo))]
    public class PalletizingInfoDto : EntityDto<Guid>
    {
        #region 属性
        /// <summary>
        /// 编码
