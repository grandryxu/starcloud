...
{
    #region 查询参数传入dto
    public class SystemMenuInfoPagedRequest : PagedResultRequestDto
    {
        /// <summary>
        /// 功能名称
        /// </summary>
    ...
    #region 创建CreateDto
    [AutoMapTo(typeof(SystemMenuInfo))]
    public class SystemMenuInfoCreatedDto : BaseCreateDto
    {
        #region 属性
        /// <summary>
        /// URL地址
    ...
    #region 修改UpdateDto
    [AutoMapTo(typeof(SystemMenuInfo))]
    public class SystemMenuInfoUpdatedDto : BaseUpdateDto
    {
        #region 属性
        /// <summary>
        /// URL地址
    ...
    #region 查询输出dto
    [AutoMapFrom(typeof(SystemMenuInfo))]
    public class SystemMenuInfoDto : EntityDto<Guid>
    {
        #region 属性
        /// <summary>
        /// URL地址
