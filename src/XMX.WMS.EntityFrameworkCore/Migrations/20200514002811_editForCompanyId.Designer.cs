...
namespace XMX.WMS.Migrations
{
    ...
    [Migration("20200514002811_editForCompanyId")]
    partial class editForCompanyId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XMX.WMS.AreaInfo.AreaInfo", b =>
                {
                    ...
                    b.Property<Guid?>("area_company_id");
            ...
            modelBuilder.Entity("XMX.WMS.ExportBillSyncLog.ExportBillSyncLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime>("expbill_creat_datetime");

                    b.Property<Guid?>("expbill_id");

                    b.Property<string>("expbill_info");

                    b.Property<string>("expbill_result");

                    b.HasKey("Id");

                    b.ToTable("ExportBillSyncLog");
                });
            ...
            modelBuilder.Entity("XMX.WMS.ExportOrder.ExportOrder", b =>
                {
                    ...
                    b.Property<decimal>("exporder_return_quantity");
            ...
            modelBuilder.Entity("XMX.WMS.ImportApplyLog.ImportApplyLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime>("import_creat_datetime");

                    b.Property<Guid?>("import_id");

                    b.Property<string>("import_info");

                    b.Property<string>("import_result");

                    b.HasKey("Id");

                    b.ToTable("ImportApplyLog");
                });
            ...
            modelBuilder.Entity("XMX.WMS.ImportBillbody.ImportBillbody", b =>
                {
                    ...
                    b.Property<decimal>("impbody_binding_quantity");
                    ...
                    b.Property<decimal>("impbody_fulfill_quantity");
                    ...
                    b.Property<decimal>("impbody_plan_quantity");
                    ...
                    b.Property<DateTime>("impbody_recheck_date");
            ...
            modelBuilder.Entity("XMX.WMS.ImportBillhead.ImportBillhead", b =>
                {
                    ...
                    b.Property<string>("imphead_datestr");
            ...
            modelBuilder.Entity("XMX.WMS.ImportOrder.ImportOrder", b =>
                {
                    ...
                    b.Property<decimal>("imporder_quantity");
                    ...
                    b.Property<int>("imporder_stock_flag");
            ...
            modelBuilder.Entity("XMX.WMS.ImportStock.ImportStock", b =>
                {
                    ...
                    b.Property<string>("impstock_lots_no");
            ...
            modelBuilder.Entity("XMX.WMS.MoveModelMenu.MoveModelMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("XMX.WMS.PlatFormInfo.PlatFormInfo", b =>
                {
                    ...
                    b.Property<Guid?>("platform_company_id");
                    ...
                    b.HasIndex("platform_company_id");
            ...
            modelBuilder.Entity("XMX.WMS.PortInfo.PortInfo", b =>
                {
                    ...
                    b.Property<Guid?>("port_company_id");
            ...
            modelBuilder.Entity("XMX.WMS.SlotInfo.SlotInfo", b =>
                {
                    ...
                    b.Property<Guid?>("slot_company_id");
                    ...
                    b.Property<Guid?>("slot_tunnel_id");
            ...
            modelBuilder.Entity("XMX.WMS.WMSOptLogInfo.WMSOptLogInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("OptAction");

                    b.Property<string>("OptModule");

                    b.Property<string>("OptPath");

                    b.Property<string>("OptResult");

                    b.HasKey("Id");

                    b.ToTable("WMSOptLogInfo");
                });
            ...
            modelBuilder.Entity("XMX.WMS.WarehouseStock.WarehouseStock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("warehouse_date");

                    b.Property<Guid>("warehouse_id");

                    b.Property<decimal>("warehouse_stock");
            ...
            modelBuilder.Entity("XMX.WMS.MoveModelMenu.MoveModelMenu", b =>
                {
                    b.HasOne("XMX.WMS.MoveModelMenu.MoveModelMenu", "modelMenu")
                        .WithMany()
            ...
            modelBuilder.Entity("XMX.WMS.PlatFormInfo.PlatFormInfo", b =>
                {
                    b.HasOne("XMX.WMS.CompanyInfo.CompanyInfo", "Company")
                        .WithMany()
                        .HasForeignKey("platform_company_id");
