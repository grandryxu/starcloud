...
export const getListApi = async function(params){
    let res = await http.get("/api/services/app/InventoryInfoService/GetSlotInventory",{params});
    return res;
}
//新增
...
export const getOneApi = async function(params){
    let res = await http.get("/api/services/app/InventoryInfoService/GetSlotInventoryDetail",{params});
    return res;
}
