	...
	<div class="iot-list" ref="page">
				...
				<el-form inline label-width="100px" :model="searchForm">
					...
					<el-form-item label="出入口类型">
						<el-select class="iot-w200" v-model="searchForm.port_type" placeholder="请选择出入口类型" clearable>
							<el-option v-for="item in portTypeList" :key="item.id" :label="item.portType" :value="item.id"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item>
		...
		<div class="iot-table">
			<el-table id="out-table" ref="print" :data="tableData" stripe style="width: 100%" border @row-dblclick="click_edit" @selection-change="handleSelectionChange">
				...
				<el-table-column align="center" prop="port_code" label="出入口编码" min-width="100" show-overflow-tooltip></el-table-column>
				<el-table-column align="center" prop="port_name" label="出入口名称" min-width="100" show-overflow-tooltip></el-table-column>
			...
			<el-form inline ref="dialogForm" :model="ruleForm" :rules="rules">
				<div class="iot-form-row">
					<el-form-item label="出入口编码" label-width="100px" prop="port_code">
						<el-input class="iot-w240" v-model="ruleForm.port_code" placeholder="请输入出入口编码" maxlength="30" clearable></el-input>
					</el-form-item>
					<el-form-item label="出入口名称" label-width="170px" prop="port_name">
						<el-input class="iot-w240" v-model="ruleForm.port_name" placeholder="请输入出入口名称" maxlength="50" clearable></el-input>
					</el-form-item>
				</div>
				<div class="iot-form-row">
