    ...
    <div class="iot-list" ref="page">
        <div class="iot-form">
            <div class="layout__search">
                <el-form inline label-width="100px" :model="searchForm">
                    ...
                    <!--<el-form-item label="所属公司" label-width="120px" prop="quality_company_id"    v-if="userId==1">
                        <el-cascader
        ...
        <div class="iot-table">
            <el-table id="out-table" ref="print" :data="tableData" stripe style="width: 100%" border
                ...
                <el-table-column align="center" prop="quality_name" label="质量状态名称" min-width="100"
                ...
                <el-table-column align="center" prop="quality_color" label="颜色" min-width="100" show-overflow-tooltip>
                    <template slot-scope="scope">
                        <div style="width:2rem;height:2rem;margin:0 auto;"
                             :style="{'background':scope.row.quality_color}"></div>
                    </template>
                </el-table-column>
            </el-table>
        </div>
            ...
            <el-form inline ref="dialogForm" :model="ruleForm" :rules="rules">
                <div class="iot-form-row">
                    <el-form-item label="质量状态名称" label-width="120px" prop="quality_name">
                        <el-input class="iot-w240" v-model="ruleForm.quality_name" maxlength="50"
                                  placeholder="请输入质量状态名称" clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="质量状态颜色" label-width="120px" prop="quality_color">
                        <el-select class="iot-w120" v-model="ruleForm.quality_color" placeholder="请选择">
                            <el-option v-for="item in colorList" :key="item.value" :label="item.label"
                                       :value="item.value">
                                <div style="width:2rem;height:2rem;font-size: 13px"
                ...
                <div class="iot-form-row" >
                   <!-- <el-form-item label="所属公司" label-width="120px" prop="quality_company_id">
					...
					<companycontrol v-if="userId==1" :companyId="companyId"  labelwidth="120px" @updateCompanyId="updateCompanyId($event)"></companycontrol>
                </div>
            </el-form>
...
<script>
    ...
    export default {
        ...
        mixins: [textConfig],
        components: {
            singlePictureUpload,Companycontrol,
        }, props: ["lang"],
        ...
        created() {
            if (Utils.getStorage("userInfo")) {
                this.ruleForm.quality_company_id = Utils.getStorage("userInfo").data.result.companyId;
        ...
        methods: {
			updateCompanyId(val) {
				if (val)
					this.ruleForm.quality_company_id = val;
				else
					this.ruleForm.quality_company_id = Utils.getStorage("userInfo").data.result.companyId;
			},
            //根据当前用户权限标识初始化按钮状态
            ...
            getlastvalue(val) {
                ...
                if (val)
                    ...
                    this.ruleForm.quality_company_id = list[list.length - 1];
            },
            ...
            async Get(row) {
                ...
                this.companyId=res.quality_company_id;
                this.ruleForm = obj;
            },
            //导出表格
            exportExcel() {
