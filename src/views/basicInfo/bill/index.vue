	...
	<div class="iot-list" ref="page">
				...
				<el-form inline label-width="100px" :model="searchForm">
					...
					<el-form-item label="单据类型">
						<el-select class="iot-w200" v-model="searchForm.bill_type" placeholder="请选择单据类型" clearable>
							<el-option v-for="item in billTypeList" :key="item.id" :label="item.billType" :value="item.id"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item>
		...
		<div class="iot-table">
			<el-table id="out-table" ref="print" :data="tableData" stripe style="width: 100%" border @row-dblclick="click_edit" @selection-change="handleSelectionChange">
				...
				<el-table-column align="center" prop="bill_name" label="单据类型名称" min-width="100" show-overflow-tooltip></el-table-column>
				...
				<el-table-column align="center" prop="bill_remark" label="备注" min-width="100" show-overflow-tooltip></el-table-column>
			</el-table>
		</div>
			...
			<el-form inline ref="dialogForm" :model="ruleForm" :rules="rules">
				<div class="iot-form-row">
					<el-form-item label="单据类型名称" label-width="120px" prop="bill_name">
						<el-input class="iot-w240" v-model="ruleForm.bill_name" maxlength="50" placeholder="请输入单据类型名称" clearable></el-input>
					</el-form-item>
				...
				<div class="iot-form-row">
					<el-form-item label="备注" label-width="120px" prop="bill_remark">
						<el-input class="iot-w240" v-model="ruleForm.bill_remark" type="textarea" :rows="4" :maxlength="200" show-word-limit></el-input>
					</el-form-item>
				</div>
				<!-- <div class="iot-form-row">
