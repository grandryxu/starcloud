	...
	<div class="iot-list" ref="page">
			...
			<div class="layout__search">
				<el-form inline label-width="100px" :model="searchForm">
					<el-form-item label="设备编号">
						<el-input class="iot-w200" placeholder v-model="searchForm.rgv_code" clearable></el-input>
					</el-form-item>
					<el-form-item label="设备名称">
						<el-input class="iot-w200" placeholder v-model="searchForm.rgv_name" clearable></el-input>
					</el-form-item>
                    <el-form-item label="所在仓库">
						<el-select class="iot-w200" v-model="searchForm.rgv_warehouse_id" placeholder="请选择" clearable>
		...
		<div class="iot-table">
			<el-table id="out-table" ref="print" :data="tableData" stripe style="width: 100%" border @row-dblclick="click_edit" @selection-change="handleSelectionChange" @row-click="clickRow">
				...
				<el-table-column align="center" prop="rgv_code" label="设备编号" min-width="100" show-overflow-tooltip></el-table-column>
				<el-table-column align="center" prop="rgv_name" label="设备名称" min-width="100" show-overflow-tooltip></el-table-column>
				...
				<el-table-column align="center" prop="rgv_remark" label="备注" min-width="100" show-overflow-tooltip></el-table-column>
			</el-table>
		</div>
		...
		<el-dialog class="iot-dialog" :title="dialogTitle" :visible.sync="dialogVisible" width="824px" append-to-body>
			<el-form inline ref="dialogForm" :model="ruleForm" :rules="rules">
				<div class="iot-form-row">
					<el-form-item label="设备编号" label-width="100px" prop="rgv_code">
						<el-input class="iot-w240" v-model="ruleForm.rgv_code" placeholder="请输入设备编号" clearable maxlength="20"></el-input>
					</el-form-item>
					<el-form-item label="设备名称" label-width="100px" prop="rgv_name">
						<el-input class="iot-w240" v-model="ruleForm.rgv_name" placeholder="请输入设备名称" clearable maxlength="20"></el-input>
					</el-form-item>
                    <el-form-item label="所在仓库" label-width="100px" prop="rgv_warehouse_id">
						<el-select class="iot-w240" v-model="ruleForm.rgv_warehouse_id" placeholder="请选择">
							<el-option v-for="item in warehouseList" :key="item.id" :label="item.warehouse_name" :value="item.id"></el-option>
						</el-select>
					</el-form-item>
					...
					<br/>
					<el-form-item label="备注" label-width="100px" prop="rgv_remark">
						<el-input class="iot-w240" type="textarea" v-model="ruleForm.rgv_remark" placeholder="请输入备注" clearable :rows="5" maxlength="200" show-word-limit></el-input>
					</el-form-item>
				</div>
			</el-form>
	...
	export default {
		...
		methods: {
			...
			async Get(row) {
				...
				let obj = {
					id:row.id,
					rgv_code:res.rgv_code,
					rgv_name:res.rgv_name,
                    rgv_remark:res.rgv_remark,
                    rgv_warehouse_id:res.rgv_warehouse_id,
