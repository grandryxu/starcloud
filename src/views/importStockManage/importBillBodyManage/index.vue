  ...
  <div class="iot-list" ref="page">
      ...
      <div class="layout__search">
        <el-form inline label-width="100px" :model="searchForm">
          <el-form-item label="入库单号">
            <el-input class="iot-w200" placeholder="请输入入库单号" maxlength="50" v-model="searchForm.imphead_code" clearable></el-input>
          </el-form-item>
          <el-form-item label="大批号">
            <el-input class="iot-w200" placeholder="请输入大批号" maxlength="50" v-model="searchForm.imporder_batch_no" clearable></el-input>
          </el-form-item>
          <el-form-item label="小批号">
            <el-input class="iot-w200" placeholder="请输入小批号" maxlength="50" v-model="searchForm.imporder_lots_no" clearable></el-input>
          </el-form-item>
          <el-form-item label="客户名称">
            <el-select class="iot-w200" v-model="searchForm.custom_name" placeholder="请选择" clearable>
              <el-option
                v-for="(item,index) in customList" :key="index" :label="item.custom_name" :value="item.custom_name"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="状态">
            <el-select class="iot-w200" v-model="searchForm.imporder_execute_flag" placeholder="请选择" clearable>
    ...
    <div class="iot-table">
      <el-table id="out-table" ref="print" :data="tableData" stripe style="width: 100%" border @row-dblclick="click_edit" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" prop="importBillbody.importBillhead.imphead_code" label="入库单号" min-width="100" show-overflow-tooltip></el-table-column>
        ...
        <!-- :formatter="toGoodsName" -->
         <el-table-column align="center" prop="imporder_batch_no" label="大批号" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="imporder_lots_no" label="小批号" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="imporder_stock_code" label="托盘号码" min-width="100" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" prop="imporder_quantity" label="数量" min-width="100" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" prop="imporder_execute_flag" label="执行状态" min-width="100" show-overflow-tooltip>
          <template slot-scope="scope">
        ...
        <el-table-column align="center" prop="imporder_noused_flag" label="是否作废" min-width="100" show-overflow-tooltip>
          <template slot-scope="scope">
      ...
      <el-form inline ref="dialogForm" :model="ruleForm" :rules="rules">
        ...
        <div class="iot-form-row">
          <el-form-item label="批次" label-width="100px" prop="impbody_batch_no">
            <el-input class="iot-w240" v-model="ruleForm.impbody_batch_no" maxlength="50" placeholder="请输入批次" clearable disabled></el-input>
          </el-form-item>
          <el-form-item label="数量" label-width="100px" prop="impbody_binding_quantity">
            <el-input class="iot-w240" v-model="ruleForm.impbody_binding_quantity" placeholder="请输入数量" maxlength="20" clearable disabled></el-input>
          </el-form-item>
        </div>
        <div class="iot-form-row">
        ...
        <div v-if="dialogTitle === '修改'">
          <h1 style="text-align:center;font-size:16px;font-weight:bolder;">{{$t('importBillBody.goodsPackDetail')}}</h1>
          <div class="layout__btns">
            <div>
          ...
          <div class="iot-table">
            <el-table :data="tableScanData" stripe style="width: 100%" border @row-dblclick="handleScanEdit" @selection-change="handleSelectionChangeOrder">
              ...
              <el-table-column align="center" prop="imporder_box_code" :label="$t('importBillBody.packCode')" min-width="100" show-overflow-tooltip></el-table-column>
              <el-table-column align="center" prop="imporder_quantity" :label="$t('public.quantity')" min-width="100" show-overflow-tooltip>
                <template slot-scope="scope">
        ...
        <div v-else-if="dialogTitle === '模拟扫描'">
          ...
          <div class="iot-table">
            <el-table :data="tableScanData.slice((currentScanPage-1)*scanPageSize,currentScanPage*scanPageSize)" stripe style="width: 100%" border @selection-change="handleSelectionScanChange">
              ...
              <el-table-column align="center" prop="imporder_quantity" label="数量" min-width="100" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-input class="iot-w150" v-model="scope.row.imporder_quantity" clearable></el-input>
                </template>
              </el-table-column>
            </el-table>
          </div>
