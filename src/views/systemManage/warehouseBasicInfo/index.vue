      ...
      <div class="layout__search">
        <el-form inline label-width="100px" :model="searchForm">
          <el-form-item label="仓库编码">
            <el-input class="iot-w200" placeholder="请输入仓库编码" maxlength="30" v-model="searchForm.warehouse_code" @change="click_search" clearable></el-input>
          </el-form-item>
          <el-form-item label="仓库名称">
            <el-input class="iot-w200" placeholder="请输入仓库名称" maxlength="50" v-model="searchForm.warehouse_name" @change="click_search" clearable></el-input>
          </el-form-item>
          <el-form-item label="仓库类型">
            <el-select class="iot-w200" v-model="searchForm.warehouse_type" placeholder="请选择" clearable @change="click_search">
