  ...
  <div class="iot-list">
      ...
      <div class="layout__search">
        <el-form inline label-width="100px" :model="searchForm">
          <el-form-item label="物料名称">
            <el-input class="iot-w200" placeholder v-model="searchForm.warehouse_code" clearable @change="click_search"></el-input>
          </el-form-item>
          <el-form-item label="批次">
            <el-input class="iot-w200" placeholder v-model="searchForm.warehouse_name" clearable @change="click_search"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <div class="iot-table">
      <el-table :data="tableData" stripe style="width: 100%" border @row-dblclick="click_edit" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" prop="imphead_code" label="报警名称" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="imphead_code" label="物料名称" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="imphead_code" label="物料编码" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="imphead_code" label="托盘" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="imphead_code" label="库位码" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="imphead_code" label="入库单号" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="imphead_code" label="批次" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_is_enable" label="阈值" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_slot_type" label="报警值" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_slot_type" label="报警开始时间" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="billInfo.bill_remark" label="备注" min-width="100" show-overflow-tooltip></el-table-column>
      </el-table>
    </div>
    ...
    <el-dialog class="iot-dialog" :title="dialogTitle" :visible.sync="dialogVisible" width="824px" append-to-body>
      <el-form inline ref="dialogForm" :model="ruleForm" :rules="rules">
        <div class="iot-form-row">
          <el-form-item label="物料名称" label-width="100px" prop="imphead_code">
            <el-input class="iot-w240" v-model="ruleForm.imphead_code" placeholder="请输入物料名称" clearable></el-input>
          </el-form-item>
          <el-form-item label="物料编码" label-width="100px" prop="imphead_external_code">
            <el-input class="iot-w240" v-model="ruleForm.imphead_external_code" placeholder="请输入物料编码" clearable></el-input>
          </el-form-item>
        </div>
        <div class="iot-form-row">
