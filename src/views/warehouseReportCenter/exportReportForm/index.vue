  ...
  <div class="iot-list" ref="page">
      ...
      <div class="layout__search">
        <el-form inline label-width="100px" :model="searchForm">
          <el-form-item label="出库单号">
            <el-input class="iot-w200" placeholder v-model="searchForm.expbody_bill_bar" clearable></el-input>
          </el-form-item>
          <el-form-item label="ERP">
            <el-input class="iot-w200" placeholder v-model="searchForm.expbody_external_listid" clearable></el-input>
          </el-form-item>
    ...
    <div class="iot-table">
      <el-table id="out-table" ref="print" :data="tableData" stripe style="width: 100%" border @row-dblclick="click_edit" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" prop="expbody_external_listid" label="ERP" min-width="100" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" prop="expbody_binding_quantity" label="出库数量" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_slot_type" label="回流数量" min-width="100" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" prop="expbody_date" label="出库日期" min-width="100" show-overflow-tooltip :formatter="dateTransform"></el-table-column>
    ...
    <el-dialog class="iot-dialog" :title="dialogTitle" :visible.sync="dialogVisible" width="824px" append-to-body>
      <el-form v-if="dialogTitle === '查阅'" inline ref="dialogForm" :model="ruleForm" :rules="rules">
        ...
        <div class="iot-form-row">
          <el-form-item label="批次" label-width="100px" prop="expbody_batch_no">
            <el-input class="iot-w240" v-model="ruleForm.expbody_batch_no" placeholder="请输入批次" clearable disabled></el-input>
          </el-form-item>
          <el-form-item label="数量" label-width="100px" prop="expbody_binding_quantity">
            <el-input class="iot-w240" v-model="ruleForm.expbody_binding_quantity" placeholder="请输入数量" clearable disabled></el-input>
          </el-form-item>
        </div>
        <div class="iot-form-row">
      ...
      <el-form v-if="dialogTitle === '复核'" inline ref="dialogForm" :model="ruleForm" :rules="rules">
        ...
        <div class="iot-form-row">
          <el-form-item label="数量" label-width="100px" prop="expbody_binding_quantity">
            <el-input class="iot-w240" v-model="ruleForm.expbody_binding_quantity" placeholder="请输入数量" clearable></el-input>
          </el-form-item>
        </div>
      </el-form>
