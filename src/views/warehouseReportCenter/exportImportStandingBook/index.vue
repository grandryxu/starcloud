  ...
  <div class="iot-list" ref="page">
      ...
      <div class="layout__search">
        <el-form inline label-width="100px" :model="searchForm">
          <el-form-item label="物资名称">
            <el-input class="iot-w200" placeholder v-model="searchForm.warehouse_code"></el-input>
          </el-form-item>
          ...
          <el-form-item label="日期选择">
            <el-date-picker v-model="searchForm.daterange" type="daterange" range-separator="-" start-placeholder="起始日期" end-placeholder="结束日期"></el-date-picker>
          </el-form-item>
          <el-form-item>
    ...
    <div class="iot-table">
      <el-table id="out-table" ref="print" :data="tableData" stripe style="width: 100%" border @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" prop="warehouse_code" label="物资名称" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_name" label="物资编码" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_name" label="日期" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_type" label="类型" min-width="100" show-overflow-tooltip>
        ...
        <el-table-column align="center" prop="warehouse_name" label="单据" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_name" label="数量" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_name" label="结存数量" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="warehouse_name" label="批次" min-width="100" show-overflow-tooltip></el-table-column>
      </el-table>
    </div>
