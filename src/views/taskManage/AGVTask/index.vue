  ...
  <div class="iot-list" ref="page">
        ...
        <el-form inline label-width="100px" :model="searchForm">
          <div class="iot-form-row">
            <el-form-item label="任务号">
              <el-input class="iot-w200" placeholder v-model="searchForm.agv_no" clearable></el-input>
            </el-form-item>
            <el-form-item label="来源">
              <el-select class="iot-w200" v-model="searchForm.agv_manual_flag" placeholder="请选择" clearable>
            ...
            <el-form-item label="托盘码">
              <el-input class="iot-w200" placeholder v-model="searchForm.agv_stock_code" clearable></el-input>
            </el-form-item>
    ...
    <div class="iot-table">
      <el-table :data="tableData" stripe style="width: 100%" border @selection-change="handleSelectionChange" @row-dblclick="click_edit">
        ...
        <el-table-column align="center" prop="agv_no" label="任务号" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="agv_priority" label="优先级" min-width="100" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column align="center" prop="agv_stock_code" label="托盘" min-width="100" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog class="iot-dialog" :title="dialogTitle" :visible.sync="dialogVisible" width="844px" append-to-body>
      <el-form inline ref="dialogForm" :model="TaskForm" :rules="TaskFormrules">
        <div class="iot-form-row">
          <el-form-item label="任务号" label-width="120px" prop="agv_no">
            <el-input class="iot-w240" v-model="TaskForm.agv_no" placeholder="请输入任务号" maxlength="30" clearable :disabled="true"></el-input>
          </el-form-item>
          ...
          <el-form-item label="优先级" label-width="120px" prop="agv_priority">
            <el-select class="iot-w240" v-model="TaskForm.agv_priority" placeholder="请选择" clearable>
              <el-option v-for="item in sortList" :key="item.id" :label="item.id" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="库位码" label-width="120px" prop="agv_stock_code">
            <el-input class="iot-w240" v-model="TaskForm.slot_code_code" placeholder="请输入库位码" maxlength="50" clearable></el-input>
          </el-form-item>
          <el-form-item label="托盘" label-width="120px" prop="agv_stock_code">
            <el-input class="iot-w240" v-model="TaskForm.agv_stock_code" placeholder="请输入托盘编码" maxlength="50" clearable></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async GetAll() {
      ...
      if (params.agv_execute_flag == null) {
        params.agv_execute_flag = 10;
      }
    ...
    async Get(row) {
      ...
      let obj = {
        id: row.id,
        agv_priority: res.agv_priority,
        agv_no: res.agv_no,
        agv_stock_code: res.agv_stock_code,
      };
      this.TaskForm = obj;
    },
    //日期时间转换
