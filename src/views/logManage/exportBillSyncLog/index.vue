  ...
  <div class="iot-list" ref="page">
    <div class="iot-form">
      <div class="layout__search">
        <el-form inline label-width="100px" :model="searchForm">
          <el-form-item label="出库单据信息">
            <el-input class="iot-w200" placeholder="请输入查询内容" maxlength="50" v-model="searchForm.expbill_info" clearable></el-input>
          </el-form-item>
          <el-form-item label="出库结果">
            <el-input class="iot-w200" placeholder="请输入查询内容" maxlength="50" v-model="searchForm.expbill_result" clearable></el-input>
          </el-form-item>
    ...
    <div class="iot-table">
      <el-table id="out-table" ref="print" :data="tableData" stripe style="width: 100%" border @selection-change="handleSelectionChange" @row-click="clickRow">
        ...
        <el-table-column align="center" prop="expbill_info" label="出库单据信息" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="expbill_result" label="出库结果" min-width="100" show-overflow-tooltip></el-table-column>
        <el-table-column align="center" prop="expbill_creat_datetime" label="出库时间" min-width="100" show-overflow-tooltip :formatter="dateFormat"></el-table-column>
      </el-table>
    </div>
