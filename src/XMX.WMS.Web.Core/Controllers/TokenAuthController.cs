...
using Abp.UI;
using XMX.WMS.Authentication.External;
using XMX.WMS.Authentication.JwtBearer;
    ...
    public class TokenAuthController : WMSControllerBase
    {
        ...
        public async Task<AuthenticateResultModel> Authenticate([FromBody] AuthenticateModel model)
        {
            ...
            foreach(string roleName in roles)
            {
                ...
                var p = await _roleManager.GetGrantedPermissionsAsync(rr.Name);
                foreach(Permission per in p)
                {
