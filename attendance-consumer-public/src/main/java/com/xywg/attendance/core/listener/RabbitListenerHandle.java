...
public class RabbitListenerHandle {
     ...
     */
    @RabbitListener(queuesToDeclare = @Queue(RABBITMQ_TOPIC_NAME_MQ))
    public void getMessage6(TransmissionMessageTemplate message) {
        methodService.runMethod(message);
     ...
     */
    @RabbitListener(queuesToDeclare = @Queue(RABBITMQ_TOPIC_NAME_MQ))
    public void getHeartMessage1(TransmissionMessageTemplate message) {
        methodService.runMethod(message);
     ...
     */
    @RabbitListener(queuesToDeclare = @Queue(RABBITMQ_TOPIC_NAME_MQ))
    public void getHeartMessage2(TransmissionMessageTemplate message) {
        methodService.runMethod(message);
