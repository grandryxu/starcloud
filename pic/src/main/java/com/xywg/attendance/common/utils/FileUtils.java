...
public class FileUtils {
     ...
     * @return
     */
    public static String getBodyIncludePhoto(String name,String body) {
        //todo 这里需要根据业务 是上传到FTP  还存在本地
        String url = "D://test//" +name;
        FileUtils.byte2image(Base64.decodeBase64(body), url);
        return  url;
