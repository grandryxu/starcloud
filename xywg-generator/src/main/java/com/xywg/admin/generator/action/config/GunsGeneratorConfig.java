package com.xywg.admin.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.1.17:3306/gblabor?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.xywg.admin.admin.common.persistence.model");
        packageConfig.setMapper("com.xywg.admin.admin.common.persistence.dao");
        packageConfig.setXml("com.xywg.admin.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.xywg.admin.admin");
        contextConfig.setCoreBasePackage("com.xywg.admin.core");
