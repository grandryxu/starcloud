package com.xywg.admin.generator.engine.config;
...
public class ContextConfig {
    ...
    private String proPackage = "com.xywg.admin.admin";
    private String coreBasePackage = "com.xywg.admin.core";
    private String modelPackageName = "com.xywg.admin.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.xywg.admin.modular.system.dao";    //model的dao
