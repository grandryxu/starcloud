        ...
        init: function (b) {
            function c(b, c, d) {
                return c.is(":visible") ? void setTimeout(function () {
                    ...
                    left: "auto",
                    right: "0"
                }), d.autoMinWidth === !1 ? c.css({"min-width": b.parent().width()}) : c.css("width", "auto"), b)
            }
            ...
            function g(b) {
                var c = a(b), d = c.parent(".input-group").find("ul.dropdown-menu"), e = c.data("bsSuggest");
                return 0 === d.length ? !1 : e ? !1 : (c.data("bsSuggest", {target: b, options: s}), !0)
            }

            function h(b, c, d, e) {
                var f, g, h, i, m, n, o, p = {value: []};
            ...
            //d为suggest参数  b为数据集合
            function m(a, b, d) {
                var e, f, g, h, j, l, m, o= a.parent().find("ul.dropdown-menu"), p = 0,
                ...
                for (q.push("<tbody>"), f = 0; e > f; f++) {
                    ...
                    m || d.indexKey !== p || (m = b.value[f][g]), l || d.indexId !== p || (l = b.value[f][g]), p++, k(g) !== !1 && (j += '<td data-name="' + g + '">' + b.value[f][d.showContent]+ "</td>");
                    j = '<tr data-param1="' + b.value[f][d.param1] + '" data-param2="' + b.value[f][d.param2] + '"  data-index="' + f + '" data-id="' + l + '" data-key="' + m + '">' + j + "</tr>", q.push(j)
                }
            ...
            function o(a) {
                var b = {};
                return b.id = a.attr("data-id"), b.key = a.attr("data-key"), b.param1=a.attr("data-param1"),b.param2=a.attr("data-param2"),b
            }

            function p(a, b, c) {
                var d, e = b || {}, f = e.id || "", g = e.key || "";
            ...
            if (a.isFunction(s.processData) && (i = s.processData), a.isFunction(s.getData) && (h = s.getData), !b.showHeader && s.effectiveFields && s.effectiveFields.length > 1 && (s.showHeader = !0), "firstByUrl" === s.getDataMethod && s.url && !s.delayUntilKeyup) {
                var t = -1 !== b.url.indexOf("?") ? "&" : "?", u = b.jsonp ? [b.url, t, b.jsonp, "=?"].join("") : b.url;
                a.ajax({type: "GET", url: u, dataType: "json", timeout: 5e3}).done(function (b) {
            ...
            return a("head:eq(0)").append("<style>." + s.listHoverCSS + "{" + s.listHoverStyle + "}</style>"), r.each(function () {
                var i = a(this), j = i.parents(".input-group:eq(0)").find("ul.dropdown-menu");
