...
DeviceReport.initColumn = function () {
    return [
        ...
        {title: '雨天', field: 'rain', visible: true, align: 'center', valign: 'middle'},
        {title: '病假', field: 'fallIll', visible: true, align: 'center', valign: 'middle'},
        {title: '事假', field: 'compassionateLeave', visible: true, align: 'center', valign: 'middle'},
        {title: '缺席', field: 'absent', visible: true, align: 'center', valign: 'middle'},
...
DeviceReport.openAddDeviceReport = function () {
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/deviceReportNew/deviceReport_add'
    });
...
DeviceReport.openDeviceReportDetail = function () {
    if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/deviceReportNew/deviceReport_update/' + DeviceReport.seItem.id
        });
        this.layerIndex = index;
    }
};
...
DeviceReport.delete = function () {
    if (this.check()) {
        var ajax = new $ax(Feng.ctxPath + "/deviceReportNew/delete", function (data) {
            Feng.success("删除成功!");
 ...
 */
DeviceReport.delete = function () {
    var ajax = new $ax(Feng.ctxPath + "/deviceReportNew/deviceReportDeal", function (data) {
        Feng.success("统计成功!");
        DeviceReport.table.refresh();
    }, function (data) {
...
$(function () {
    ...
    var table = new BSTable(DeviceReport.id, "/deviceReportNew/list", defaultColunms);
...
DeviceReport.download = function () {
    window.location.href = Feng.ctxPath + "/deviceReportNew/download?"
...
DeviceReport.overTimeAdd = function () {
    ...
    var index = layer.open({
        ...
        maxmin: true,
        skin: "layer-detail",
        content: Feng.ctxPath + '/deviceReportNew/deviceReport_over/' + DeviceReport.seItem.id
    });
    this.layerIndex = index;
}
};
