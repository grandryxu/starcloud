...
$(function () {
    ...
    var table = new BSTable(DeviceRecord.id, "/deviceRecord/getDeviceRecordByProjectCode?projectCode=" + $("#projectCode").val()+"&page="+$("#page").val(), defaultColunms);
    table.setPaginationType("server");
    table.onDblClickRow = DeviceRecord.searchInfo;//双击事件所对应的方法 要放在init之前
    table.onLoadSuccess = DeviceRecord.onLoadSuccess;
