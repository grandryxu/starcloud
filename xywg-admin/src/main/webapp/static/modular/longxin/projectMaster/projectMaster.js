...
ProjectMaster.initColumn = function () {
    return [
        ...
        {title: '项目所在地', field: 'areaName', visible: true, align: 'center', valign: 'middle'},
        {title: '所属公司', field: 'generalContractorName', visible: true, align: 'center', valign: 'middle'},
...
/*        {title: '招标信息', field: 'status', visible: true, align: 'center', valign: 'middle',
        ...
        {title: '招标管理', field: 'status', visible: true, align: 'center', valign: 'middle',
            formatter: function (value, row, index) {


                    return "<a size='2' color='blue' onclick='SubContractor.openAddSubContractor(\""+ row.id +"\")'>管理招标1</a>" ;
