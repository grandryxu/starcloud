...
ProjectSubContractor.openProjectContractorEvaluation = function () {
    if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/lxEvaluate/projectSubContractor_evaluation/'+ ProjectSubContractor.seItem.id
        });
        this.layerIndex = index;
    }
}
...
$(function () {
   ...
   /* console.log(projectId)*/
    ...
    var table = new BSTable(ProjectSubContractor.id, "/lxProject/companyDbList/"+projectId, defaultColunms);

    table.setPaginationType("server");
    table.onDblClickRow = ProjectSubContractor.searchInfo;
    table.onLoadSuccess = ProjectSubContractor.onLoadSuccess;
