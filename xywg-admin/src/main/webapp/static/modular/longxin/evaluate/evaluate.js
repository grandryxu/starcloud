...
ProjectMaster.initColumn = function () {
    ...
    return [
        ...
        {title: '评分项', field: 'items', visible: true, align: 'center', valign: 'middle'},
        {title: '评分类型', field: 'type', visible: true, align: 'center', valign: 'middle'},
        {title: '分值上限', field: 'max', visible: true, align: 'center', valign: 'middle',
...
ProjectMaster.openAddProjectMaster = function () {
    var index = layer.open({
        ...
        maxmin: true,
        skin: "layer-detail",
        content: Feng.ctxPath + '/lxEvaluate/lxEvaluate_add'
    });
    layer.full(index);
    this.layerIndex = index;
};
...
$(function () {
    ...
    var table = new BSTable(ProjectMaster.id, "/lxEvaluate/list", defaultColunms);
