...
/*
 ...
 /*   //项目地址
    ...
    if ($("#max").val()<0||$("#max").val()>10||$("#max").val()%1!=0){
        Feng.error("请填写1-10的整数!");
        return false;
    }

    var  num=0;
    var ajaxItems = new $ax(Feng.ctxPath + "/lxEvaluate/selectItems", function (data) {
        num=data;
    }, function (data) {
        Feng.error("查询失败!" + data.responseJSON.message + "!");
    });
    ajaxItems.set("items",$("#items").val());
    ajaxItems.start();
    ...
    var ajax = new $ax(Feng.ctxPath + "/lxEvaluate/add", function (data) {
...
/*
    ...
    var ajax = new $ax(Feng.ctxPath + "/lxEvaluate/update", function (data) {
        Feng.success("修改成功!");
        window.parent.ProjectMaster.table.refresh();
        ProjectMasterInfoDlg.close();
    }, function (data) {
