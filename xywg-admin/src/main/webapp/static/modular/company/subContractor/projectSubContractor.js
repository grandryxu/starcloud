...
ProjectSubContractor.initColumn = function () {
    return [
            ...
            {title: '退场时间', field: 'exitTime', visible: false, align: 'center', valign: 'middle'},
            {title: '状态', field: 'statusName', visible: true, align: 'center', valign: 'middle'},
            {title: '发放工资的银行名称', field: 'bankName', visible: false, align: 'center', valign: 'middle'},
            {title: '发放工资的共管银行账户', field: 'bankNumber', visible: false, align: 'center', valign: 'middle'},
            {title: '银行联号', field: 'bankLinkNumber', visible: false, align: 'center', valign: 'middle'},
            {title: '工资发放模式', field: 'payMode', visible: false, align: 'center', valign: 'middle'},
            {title: '项目经理名称', field: 'pmName', visible: false, align: 'center', valign: 'middle'},
            {title: '身份类型', field: 'pmIdcardTypeName', visible: false, align: 'center', valign: 'middle'},
            {title: '身份证号码', field: 'pmIdcardNumber', visible: false, align: 'center', valign: 'middle'},
            {title: '项目经理电话', field: 'pmPhone', visible: false, align: 'center', valign: 'middle'}
    ];
};
...
$(function () {
    ...
    table.setQueryParams({
        subOrganizationCode: $("#organizationCode").val()
    });
