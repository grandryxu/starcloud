...
function getTrueColumns(){
	var tCols = [];
	var columns = $('#WorkerMasterTable').bootstrapTable('getVisibleColumns');
...
$(function () {
    ...
    var table = new BSTable(WorkerMaster.id, "/workerMaster/list", defaultColunms);
