...
import java.util.Iterator;  
	...
	/*
	 * public static void main(String[] args) { String str = "性别"; // 转换成拼音
	 * System.out.println(test.getFullSpell("人员证件类型")); // 中文第一个字全拼,其余去首字母
	 * System.out.println(test.getFirstSpell("工种字典数据"));
	 * 
	 * }
	 */
    }  