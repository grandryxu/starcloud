...
public class JointCommand {
     ...
     * @param userName
     */
    public static String jointUserInfo(String uuid, String idCardNumber, String userName,String cardNumber) {
     ...
     * @param base64
     */
    public static String jointUserFace(String uuid, String idCardNumber, String base64) {
     ...
     * @param base64
     */
    public static String jointUserPhoto(String uuid, String idCardNumber, String base64) {
