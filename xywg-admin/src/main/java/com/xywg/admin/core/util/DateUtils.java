...
import com.xywg.admin.modular.device.subtable.TableSuffixUtil;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 * @return
	 */
	public static List<String> getMonthList(String year) {
		...
		try {
			Date start = sdf.parse(year.concat("-01"));
			Date end = sdf.parse(year + "-12");

			Calendar dd = Calendar.getInstance();
			dd.setTime(start);

			while (!dd.getTime().after(end)) {
	...
	public static String getPreMonth() {
		...
		LocalDateTime month = ldt.minusMonths(1);
	...
	public static String getTableSuffix() {
		return TableSuffixUtil.getTableSuffix();
	}
}
