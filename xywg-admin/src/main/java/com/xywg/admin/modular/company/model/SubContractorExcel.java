...
@Data
public class SubContractorExcel extends Model<SubContractorExcel> {
    ...
    public SubContractorExcel() {
    }

    public SubContractorExcel(String companyName, String organizationType, String socialCreditNumber, String bizRegisterCode ,
