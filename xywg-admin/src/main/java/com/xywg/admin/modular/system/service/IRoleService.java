...
public interface IRoleService extends IService<Role> {
     ...
     */
    List<Map<String, Object>> selectRoles(@Param("condition") String condition,List<Integer> iDepts);
     ...
     * @date 2017年2月18日 上午10:32:04
     */
    List<ZTreeNode> roleTreeListByRoleId(String[] roleId,List<Integer>  iDepts);
