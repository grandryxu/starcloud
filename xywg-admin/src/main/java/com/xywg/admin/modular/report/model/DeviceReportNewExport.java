 ...
 * @since 2018-06-16
 */
public class DeviceReportNewExport extends Model<DeviceReportNewExport> {
    ...
    @ExcelField(title = "企业组织机构代码", order = 1)
    ...
    @ExcelField(title = "班组编号", order = 6)
    private Integer teamSysNo;
    @ExcelField(title = "班组名称", order = 7)
    private String teamName;
    @ExcelField(title = "统计所在月份", order =8)
    private String time;
    @ExcelField(title = "总工时", order = 9)
    private Double totalCount;
    @ExcelField(title = "出勤天数", order = 10)
    private Integer totalDate;
    @ExcelField(title="雨天", order = 11)
    private Double rain;
    @ExcelField(title="病假", order = 12)
    private Double fallIll;
    @ExcelField(title = "事假", order = 13)
    private Double compassionateLeave;
    @ExcelField(title = "缺席", order = 14)
    private Double absent;
    @ExcelField(title = "01", order = 15)
    private Double day01;
    @ExcelField(title = "02", order = 16)
    private Double day02;
    @ExcelField(title = "03", order = 17)
    private Double day03;
    @ExcelField(title = "04", order = 18)
    private Double day04;
    @ExcelField(title = "05", order = 19)
    private Double day05;
    @ExcelField(title = "06", order = 20)
    private Double day06;
    @ExcelField(title = "07", order = 21)
    private Double day07;
    @ExcelField(title = "08", order = 22)
    private Double day08;
    @ExcelField(title = "09", order = 23)
    private Double day09;
    @ExcelField(title = "10", order = 24)
    private Double day10;
    @ExcelField(title = "11", order = 25)
    private Double day11;
    @ExcelField(title = "12", order = 26)
    private Double day12;
    @ExcelField(title = "13", order = 27)
    private Double day13;
    @ExcelField(title = "14", order = 28)
    private Double day14;
    @ExcelField(title = "15", order = 29)
    private Double day15;
    @ExcelField(title = "16", order = 30)
    private Double day16;
    @ExcelField(title = "17", order = 31)
    private Double day17;
    @ExcelField(title = "18", order = 32)
    private Double day18;
    @ExcelField(title = "19", order = 33)
    private Double day19;
    @ExcelField(title = "20", order = 34)
    private Double day20;
    @ExcelField(title = "21", order = 35)
    private Double day21;
    @ExcelField(title = "22", order = 36)
    private Double day22;
    @ExcelField(title = "23", order = 37)
    private Double day23;
    @ExcelField(title = "24", order = 38)
    private Double day24;
    @ExcelField(title = "25", order = 39)
    private Double day25;
    @ExcelField(title = "26", order = 40)
    private Double day26;
    @ExcelField(title = "27", order = 41)
    private Double day27;
    @ExcelField(title = "28", order = 42)
    private Double day28;
    @ExcelField(title = "29", order = 43)
    private Double day29;
    @ExcelField(title = "30", order = 44)
    private Double day30;
    @ExcelField(title = "31", order = 45)
