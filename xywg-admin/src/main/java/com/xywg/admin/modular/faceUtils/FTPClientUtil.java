...
public class FTPClientUtil {
	...
	public static FTPClient connectFtp()throws SocketException, IOException {
		return connectFtp(SpringContextHolder.getApplicationContext().getEnvironment().getProperty("ftp.host"),
				Integer.parseInt(SpringContextHolder.getApplicationContext().getEnvironment().getProperty("ftp.port")),
				SpringContextHolder.getApplicationContext().getEnvironment().getProperty("ftp.username"),
				SpringContextHolder.getApplicationContext().getEnvironment().getProperty("ftp.password"));
	}
