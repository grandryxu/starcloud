...
import com.xywg.admin.core.common.constant.dictmap.DictMap;
...
import com.xywg.admin.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
    ...
    public Object delete(@RequestParam Integer dictId) {
        String dictName = ConstantFactory.me().getDictName(dictId);
        if ("设备类型".equals(dictName)) {
            //判断设备类型是否被使用
            List<Device> deviceList = deviceService.getDevicesByDeviceType(Long.valueOf(dictId));
