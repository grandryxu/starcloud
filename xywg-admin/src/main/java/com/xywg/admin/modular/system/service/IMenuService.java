...
public interface IMenuService extends IService<Menu> {
     ...
     * @date 2017年2月12日 下午9:14:34
     */
    List<Long> getMenuIdsByRoleList(@Param("roleList") List<Integer> roleList);
     ...
     * @date 2017年2月19日 下午1:33:51
     */
    List<ZTreeNode> menuTreeListByMenuIds(List<Long> menuIds,List<Long>   loginUserMenuIds);
     ...
     */
    List<MenuNode> getMenusByRoleIds(List<Integer> roleIds, String projectCode, Map<String, String> menuMap);
}
