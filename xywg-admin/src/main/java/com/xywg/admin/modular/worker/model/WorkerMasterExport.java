 ...
 */
@Data
public class WorkerMasterExport extends Model<WorkerMasterExport> {
    ...
    @ExcelField(title = "*籍贯", order = 9)
    private String birthPlaceCodeName;

    /**
     * 地址
     */
    @ExcelField(title = "*地址", order = 10)
    ...
    @ExcelField(title = "政治面貌", order = 11)
    ...
    @ExcelField(title = "文化程度", order = 12)
    ...
    @ExcelField(title = "是否加入工会",order = 13)
    private String isJoinedName;
    /**
     * 加入工会时间
     */
    @ExcelField(title = "加入工会时间", order = 14)
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    ...
    @ExcelField(title = "是否有重大病史", order = 15)
    private String hasBadMedicalHistoryName;
    /**
     * 开始工作日期 精确到月即可
     */
    @ExcelField(title = "开始工作日期", order = 16)
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    private Date workDate;
    /**
     * 紧急联系人姓名
     */
    @ExcelField(title = "紧急联系人姓名", order = 17)
    private String urgentContractName;
    /**
     * 紧急联系人联系电话
     */
    @ExcelField(title = "紧急联系人联系电话", order = 18)
    ...
    @ExcelField(title = "是否录入人脸", order = 19)
    ...
    @ExcelField(title = "是否认证", order = 20)
