 ...
 * @since 2019-08-29
 */
@TableName("buss_sub_contractor_reg")
@Data
public class RegSubContractor extends Model<RegSubContractor> {
	private static Logger log = LoggerFactory.getLogger(RegSubContractor.class);
   ...
   private Date date;*/
    ...
    public RegSubContractor() {
    }

    public RegSubContractor(String companyName, String organizationType, String socialCreditNumber, String bizRegisterCode ,
