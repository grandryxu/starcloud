...
@Data
public class ProjectWorker extends Model<ProjectWorker> {
...
1=Yes=有
    ...
    @TableField(value ="team_worker_type")
    ...
    public  ProjectWorker(String projectCode, String organizationCode, Integer teamSysNo, String idCardType, String idCardNumber, String workTypeCode,int workerRole,int hasContract,Integer joinStatus,Date entryTime){
    ...
    public ProjectWorker(String projectCode, String organizationCode, Integer teamSysNo, String idCardType, String idCardNumber, Integer joinStatus, String workTypeCode, String cellPhone, Integer hasContract, Integer workerRole) {
        this.projectCode = projectCode;
        this.organizationCode = organizationCode;
        this.teamSysNo = teamSysNo;
        this.idCardType = idCardType;
