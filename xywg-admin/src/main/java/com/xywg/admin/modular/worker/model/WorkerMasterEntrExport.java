 ...
 */
@Data
public class WorkerMasterEntrExport extends Model<WorkerMasterEntrExport> {
    ...
    @ExcelField(title = "工种", order = 6)
    private String workTypeCodeName;
    
    /**
     * 出生日期 身份证上获取的出生日期，格式：1990-04-08
     */
    @ExcelField(title = "出生日期", order = 12)
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    private Date birthday;
    
    private String nationName;
    
    @ExcelField(title = "性别", order = 11)
    private String genderName;
    
    /**
     * 地址
     */
    @ExcelField(title = "地址", order = 12)
    ...
    @ExcelField(title = "进场时间", order = 9)
    private Date entryTime;
    
    @ExcelField(title = "退场时间", order = 10)
