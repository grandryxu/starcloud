...
import com.xywg.admin.oauth.oauth.validator.TokenClientDetailsValidator;
...
public class TokenAuthorizeHandler extends AbstractAuthorizeHandler {
    ...
    * */
    ...
    private void normalTokenResponse(AccessToken accessToken) throws OAuthSystemException {
        ...
        final JSONObject oAuthResponse = createTokenResponse(accessToken, true);
        LOG.debug("'token' response: {}", oAuthResponse);

        WebUtils.writeOAuthJSONObjectResponse(response, oAuthResponse);
    }
