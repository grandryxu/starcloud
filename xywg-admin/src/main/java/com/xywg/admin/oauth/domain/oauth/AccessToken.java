package com.xywg.admin.oauth.domain.oauth;

import com.xywg.admin.oauth.domain.AbstractDomain;
import com.xywg.admin.oauth.infrastructure.DateUtils;
...
public class AccessToken extends AbstractDomain implements Serializable {
