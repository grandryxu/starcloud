...
import com.xywg.admin.core.excel.handler.ExcelHeader;
import com.xywg.admin.core.excel.handler.ExcelTemplate;
import com.xywg.admin.core.excel.utils.Utils;
...
public class ExcelUtils {
    ...
    public void exportObjects2Excel(List<Map<String, Object>> data, List<String> header, OutputStream os,
                                    List<String> columns) throws Exception {

        exportExcelNoModuleHandler(data, header, null, true, columns).write(os);
    }
    private Workbook exportExcelNoModuleHandler(List<Map<String, Object>> data, List<String> header, String sheetName,
                                                boolean isXSSF, List<String> columns) throws Exception {
        ...
        for (Map map : data) {
            ...
            for (String key : columns) {
                row.createCell(j, Cell.CELL_TYPE_STRING)
                        .setCellValue(String.valueOf(map.get(key) == null ? "" : map.get(key)));
                j++;
