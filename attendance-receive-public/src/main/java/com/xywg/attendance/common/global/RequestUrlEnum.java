...
public enum RequestUrlEnum {
     ...
     * 获取全部人员命令
     */
    HANDLE_GET_ALL_COMMAND("handleGetAllCommand", "/iclock/getAllRequest\\?SN=([\\s\\S]*)", "Get", "获取命令"),
     ...
     */
    HANDLE_EXCHANGE_FACTOR("handleExchangeFactor", "/iclock/exchange\\?SN=([\\s\\S]*)&type=factors", "POST", "交换因子"),


    /**
     * 具有相同的url
     */
    TABLE_OPERLOG("handleTableOperLog", "/iclock/cdata\\?SN=([\\s\\S]*)&table=OPERLOG([\\s\\S]*)", "POST", "table=OPERLOG相同URL(设备端新增人员信息)"),
